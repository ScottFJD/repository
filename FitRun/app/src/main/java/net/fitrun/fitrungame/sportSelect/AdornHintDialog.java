...
public class AdornHintDialog extends Dialog {

    private Context mContext;
    public AdornHintDialog(Context context) {
        super(context);
        this.mContext = context;
    }

    public AdornHintDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected AdornHintDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        ...
        Glide.with(mContext).load(R.drawable.adron_hint).into(hihtImage);
