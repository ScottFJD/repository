...
public class SpeedSportStatementActivity extends BaseActivity implements View.OnClickListener {
    private ImageView back,iv_zxing,exit_login;
    private TextView current_time,sport_time,sport_dis,sport_kcal
            ,sport_max_heart,sport_max_speed,sport_mean_speed,sport_mean_tempo_speed
            ,sport_max_tempo_speed,sport_min_tempo_speed,sport_type,sport_type_name;
    //初始化图片加载
    ...
    protected int getContentViewId() {
        return R.layout.layout_speed_sport_statement;
    }
    ...
    public void initView() {
        ...
        man_bg = (ImageView)findViewById(R.id.statement_main_bg);
        Glide.with(this).load(R.drawable.sport_tatement).into(man_bg);
        ...
        sport_type = (TextView)findViewById(R.id.sport_type);
        sport_type_name = (TextView)findViewById(R.id.sport_type_name);
        sport_type_name.setText(courseName);
        //设置值
        ...
        sport_type.setTypeface(typeFace_sport);
        sport_type_name.setTypeface(typeFace_sport);
        ...
        mExitHintDialog = new ExitHintDialog(SpeedSportStatementActivity.this);
    }
     ...
     */
    private void create() {
        int width = DensityUtil.dip2px(this, 550);
            ...
            case R.id.exit_login:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(SpeedSportStatementActivity.this, MainActivity.class));
                    }
                },5000);
