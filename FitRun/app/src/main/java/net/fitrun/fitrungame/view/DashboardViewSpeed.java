 ...
 */
public class DashboardViewSpeed extends View {

    private int mRadius; // 扇形半径
    private int mStartAngle = 150; // 起始角度
    private int mSweepAngle = 240; // 绘制角度
    private int mMin = 4; // 最小值
    private int mMax = 13; // 最大值
    ...
    public DashboardViewSpeed(Context context) {
        this(context, null);
    }

    public DashboardViewSpeed(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardViewSpeed(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* canvas.save();
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.border_yello));
