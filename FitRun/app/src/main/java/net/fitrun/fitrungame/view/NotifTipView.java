 ...
 */
public class NotifTipView extends FrameLayout {
    ...
    public NotifTipView(Context context) {
        this(context, null);
    }

    public NotifTipView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NotifTipView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.mipmap.notif);
        head_girl = loadDrawable(R.mipmap.notif);
