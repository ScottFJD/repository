 ...
 */
public class NotifTipView_n extends FrameLayout {
    ...
    public NotifTipView_n(Context context) {
        this(context, null);
    }

    public NotifTipView_n(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NotifTipView_n(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.mipmap.notif_n);
        head_girl = loadDrawable(R.mipmap.notif_n);
