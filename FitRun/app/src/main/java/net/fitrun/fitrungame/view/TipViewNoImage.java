 ...
 */
public class TipViewNoImage extends FrameLayout {
    ...
    public TipViewNoImage(Context context) {
        this(context, null);
    }

    public TipViewNoImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TipViewNoImage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.drawable.notif);
        head_girl = loadDrawable(R.drawable.notif);
